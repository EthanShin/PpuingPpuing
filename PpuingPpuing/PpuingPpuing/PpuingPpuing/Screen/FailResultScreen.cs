...
{
    class FailResultScreen : IScreen
    {
        #region 변수
        ...
        public override void Init(ContentManager content)
        {
            ...
            m_Fail = content.Load<Texture2D>("ResultScreen/Fail");
            InitUI(content);
        }
        private void InitUI(ContentManager content)
        {
            ...
            m_Resetbutton.Init(content, new Vector2(500, 300), 0.85f, "UI/Replay");
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(m_LeafImage, new Vector2(GraphicsDeviceManager.DefaultBackBufferWidth / 2 + m_LeafImage.Width / 2, 150), null, Color.White, 0, Vector2.Zero, 0.5f, SpriteEffects.None, 0);
            spriteBatch.Draw(m_FullBeadImage, new Vector2(GraphicsDeviceManager.DefaultBackBufferWidth / 2 + m_FullBeadImage.Width / 2, 230), null, Color.White, 0, Vector2.Zero, 0.5f, SpriteEffects.None, 0);

            spriteBatch.Draw(m_EmptyBeadImage, new Vector2(GraphicsDeviceManager.DefaultBackBufferWidth / 2 + m_EmptyBeadImage.Width / 2, 230), new Rectangle(0, 0, m_EmptyBeadImage.Width, tempBead), Color.White, 0, Vector2.Zero, 0.5f, SpriteEffects.None, 0);
            spriteBatch.Draw(m_Fail, new Vector2(400, 100), null, Color.White, 0, Vector2.Zero, 0.7f, SpriteEffects.None, 0);
            spriteBatch.DrawString(m_Font, Convert.ToString(m_NumberOfLeaf), new Vector2(GraphicsDeviceManager.DefaultBackBufferWidth / 2 + (float)(m_LeafImage.Width * 1.2), 150), Color.White);
            spriteBatch.DrawString(m_Font, Convert.ToString(100 - tempBead), new Vector2(GraphicsDeviceManager.DefaultBackBufferWidth / 2 + (float)(m_EmptyBeadImage.Width * 1.2), 230), Color.White);
